...
import userActivityData from "@/app/data/user-activity.json"
...
// Fix the user activity data type
...
const typedUserActivityData = userActivityData as unknown as UserActivityData
...
export default function HomePage() {
  ...
  const userData = typedUserActivityData.users
  const totalEntries = typedUserActivityData.totalEntries
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {typedUserActivityData.users.map((activity: UserActivity) => (
              <tr key={activity.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{activity.clicks}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{activity.timestamp}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{activity.fraudReason}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${activity.modeColor}`}>
                    {activity.mode}
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
